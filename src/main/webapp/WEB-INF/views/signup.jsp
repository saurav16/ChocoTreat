...
<body>
	...
	<div class="container" ng-app="myApp" ng-controller="abc">
		...
		<form:form class="form-horizontal" modelAttribute="User"
			action="AddUserToDB" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<label ng-if="UserNameCheck == true" class="text text-danger">Invalid
						Username Value. Cannot Be Empty</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="email" type="text" name="email" value=""
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="phone" type="text" name="phone" value=""
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="location" type="text" name="location" value=""
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-info"
						ng-disabled="OverallError == true">Submit</button>
				</div>
			</div>
