							...
							function($http, $q) {
								...
								return {
									...
									deleteAllFromCart : function(item) {
										return $http
												.post(
														'http://localhost:8080/ChocoTreat/flows/deleteAllFromCart/',
														item)
												.then(
														function(response) {
...
<body ng-app="myApp" ng-controller="abc">
	...
	<a href="${pageContext.request.contextPath}/contactus"
		class="btn btn-danger btn-lg btn pull-right">Contact Us</a>
	...
	<div class="container" align="center">
		...
		<h1 style="color: blue;">THANK YOU FOR SHOPPING WITH US!! YOUR
			ORDER HAS BEEN CONFIRMED. WE HOPE TO SEE YOU AGAIN</h1>
