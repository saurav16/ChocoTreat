							...
							function($http, $q) {
								...
								return {
									...
									updateAddresses : function(item) {
										return $http
												.post(
														'http://localhost:8080/ChocoTreat/flows/updateAddresses/',
														item)
												.then(
														function(response) {
...
<body ng-app="myApp" ng-controller="abc">
	...
	<a href="${flowExecutionUrl}&_eventId=ViewCompleteOrder"
		class="btn btn-primary btn-lg btn pull-right">Confirm Details<span
		...
		<div class="pge2" align="center">
			...
			<div>
				<input type="button" value="Update" class="btn btn-success"
					...
					ng-disabled="shippingAddress=='' || billingAddress==''">
			</div>
			<br>
			<br>
