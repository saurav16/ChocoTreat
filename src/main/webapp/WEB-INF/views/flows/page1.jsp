							...
							function($http, $q) {
								return {
									deleteFromCart : function(item) {
										return $http
												.post(
														'http://localhost:8080/ChocoTreat/flows/deleteFromCart/',
														item)
												.then(
														function(response) {
									...
									fetchAllItems : function(item) {
										return $http
												.post(
														'http://localhost:8080/ChocoTreat/flows/fetchAllItems/')
												.then(
														function(response) {
															return response.data;
														},
...
<body ng-app="myApp" ng-controller="abc">
	...
	<a href="${pageContext.request.contextPath}/products"
		class="btn btn-primary btn-lg btn pull-left"><span
		class="glyphicon glyphicon-chevron-left"></span>Return to products</a>
