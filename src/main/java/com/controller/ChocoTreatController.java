...
import com.controller.cart.CartService;
import com.controller.category.Category;
import com.controller.category.CategoryService;
import com.controller.product.Product;
import com.controller.product.ProductService;
import com.controller.user.User;
import com.controller.user.UserService;
import com.controller.userrole.UserRoleService;

@Controller
public class ChocoTreatController {
	...
	public String addToCart(HttpServletRequest request) {
		...
		if (auth != null && !auth.getName().equals("anonymousUser")) {
			...
			for (Cart item : cartlist) {
				if (item.getProductID().equals(request.getParameter("pid"))
						&& item.getUserName().equals(auth.getName())) {
